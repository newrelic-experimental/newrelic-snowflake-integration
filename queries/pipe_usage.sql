...
select pipe_name, avg(credits_used) as "CREDITS_USED_AVERAGE", sum(credits_used) as "CREDITS_USED_SUM", avg(bytes_inserted) as "BYTES_INSERTED_AVERAGE", sum(bytes_inserted) as "BYTES_INSERTED_SUM",
