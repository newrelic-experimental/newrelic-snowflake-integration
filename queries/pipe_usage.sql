...
select pipe_name,
       ...
       avg(bytes_inserted) as "BYTES_INSERTED_AVERAGE",
       sum(bytes_inserted) as "BYTES_INSERTED_SUM",
       avg(files_inserted) as "FILES_INSERTED_AVERAGE",
       sum(files_inserted) as "FILES_INSERTED_SUM"
